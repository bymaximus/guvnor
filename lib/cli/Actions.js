...
Actions.prototype._parseStartProcessOpts = function (options) {
  var opts = {
	...
	restartRetries: options.restartRetries || undefined,
	restartOnError: (options.restartOnError === true || options.restartOnError === false ? options.restartOnError : undefined),
